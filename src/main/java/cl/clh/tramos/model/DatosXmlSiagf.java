...
/**
 * The persistent class for the "DATOS_XML_SIAGF" database table.
 * 
 */
@Entity
@Table(name="\"DATOS_XML_SIAGF\"")
@NamedQuery(name="DatosXmlSiagf.findAll", query="SELECT d FROM DatosXmlSiagf d")
public class DatosXmlSiagf implements Serializable {
