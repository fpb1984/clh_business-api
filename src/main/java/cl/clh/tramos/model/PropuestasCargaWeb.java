...
/**
 * The persistent class for the "PROPUESTAS_CARGA_WEB" database table.
 * 
 */
@Entity
@Table(name="\"PROPUESTAS_CARGA_WEB\"")
@NamedQuery(name="PropuestasCargaWeb.findAll", query="SELECT p FROM PropuestasCargaWeb p")
public class PropuestasCargaWeb implements Serializable {
	...
	@Column(name="id_estado_vigente")
	private Integer idEstadoVigente;
	...
	public Integer getIdEstadoVigente() {
		return this.idEstadoVigente;
	}

	public void setIdEstadoVigente(Integer idEstadoVigente) {
		this.idEstadoVigente = idEstadoVigente;
	}
