...
/**
 * The persistent class for the "TMP_DATOS_XML_SIAGF" database table.
 * 
 */
@Entity
@Table(name="\"TMP_DATOS_XML_SIAGF\"")
@NamedQuery(name="TmpDatosXmlSiagf.findAll", query="SELECT t FROM TmpDatosXmlSiagf t")
public class TmpDatosXmlSiagf implements Serializable {
