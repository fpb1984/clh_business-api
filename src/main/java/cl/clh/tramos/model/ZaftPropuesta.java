...
/**
 * The persistent class for the "ZAFT_PROPUESTAS" database table.
 * 
 */
@Entity
@Table(name="\"ZAFT_PROPUESTAS\"")
@NamedQuery(name="ZaftPropuesta.findAll", query="SELECT z FROM ZaftPropuesta z")
public class ZaftPropuesta implements Serializable {
