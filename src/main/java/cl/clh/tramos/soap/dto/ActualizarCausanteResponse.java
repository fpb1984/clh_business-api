...
@XmlRootElement(name = "actualizarCausanteResponse")
public class ActualizarCausanteResponse {

    @XmlElementRef(name = "return", namespace = "http://ws.siagf.paperless.cl", type = JAXBElement.class, required = false)
