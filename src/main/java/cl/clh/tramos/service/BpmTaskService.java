...
public class BpmTaskService {
	...
	public List<Propuesta> getCurrentTask(String user, String pass) {
		  ...
		  final String uri = "http://clh-kie-api-qa-pam-dm.apps.ocp-esc.losheroes.int/rgp-kieserver-client-api/pam/getCurrentTaskVars?userId=" + user +"&pass=" + pass;
	...
	public void completeTask(String user, String pass, HashMap<String, Object> vars) {
		  final String uri = "http://clh-kie-api-qa-pam-dm.apps.ocp-esc.losheroes.int/rgp-kieserver-client-api/pam/completeStartTask?userId=" + user +"&pass=" + pass;
		  RestTemplate restTemplate = new RestTemplate();
